...
-- 01 
-- Zajêcia prowadzone przez Tomasza Ulatowskiego
...
-- 02 --
-- Liczba wolnych miejsc na zajêciach
SELECT
...
-- 03 --
-- £¹czna liczba osób zapisanych na poszczególne sztuki walki
...
-- 04 --
-- Imie i nazwisko trenera, z którym uczestnik o to¿samoœci Dorota Epicka ma zajecia 
...
-- 05 --
-- Liczba zajêæ w tygodniu ka¿dego trenera
...
-- 07 --
-- Jaka czeœæ wszystkich osob stanowi¹ kobiety chodz¹ce na kung-fu
...
-- 08
-- uczestnicy, którzy nie s¹ zapisani na ¿adne zajêcia
SELECT *
FROM uczestnicy AS u
WHERE NOT EXISTS (
	SELECT *
...
-- 09 --
-- Œrednia stawka godzinowa wszystkich trenerów
SELECT AVG(t.stawka)
FROM trenerzy AS t

-- 10 --
-- trenerzy oraz jezyki w jakich potrafia nauczaæ wraz z poziomem
...
-- 11
-- Sprawdzanie, czy dla ka¿dych wpisanych zajêæ istnieje przynajmniej jeden uczestnik
SELECT zajecia
FROM zajecia AS z 
